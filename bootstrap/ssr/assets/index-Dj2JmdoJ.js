...
`, $ = ({ toast: e2 }) => {
  ...
  return t$1 !== void 0 ? typeof t$1 == "string" ? reactExports.createElement(Pe, null, t$1) : t$1 : o2 === "blank" ? null : reactExports.createElement(Se, null, reactExports.createElement(F, { ...s2 }), o2 !== "loading" && reactExports.createElement(be, null, o2 === "error" ? reactExports.createElement(C, { ...s2 }) : reactExports.createElement(L, { ...s2 })));
};
var Re = (e2) => `
...
reactExports.memo(({ toast: e2, position: t$1, style: o2, children: s2 }) => {
  let a2 = e2.height ? ke(e2.position || t$1 || "top-center", e2.visible) : { opacity: 0 }, i2 = reactExports.createElement($, { toast: e2 }), r = reactExports.createElement(Ie, { ...e2.ariaProps }, h(e2.message, e2));
