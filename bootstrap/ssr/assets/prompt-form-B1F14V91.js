...
function PromptForm() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Card, { children: [
    /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: "Generate Your Prompt" }) }),
      ...
      "form",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsx(InputError, { message: errors.keyword })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-blue-50 p-5 dark:bg-blue-900/20", children: [
            /* @__PURE__ */ jsx("h3", { className: "mb-3 text-lg font-semibold text-blue-800 dark:text-blue-300", children: "Quick Examples (Click to use):" }),
            ...
            ].map((example, index) => /* @__PURE__ */ jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-lg", children: ["📧", "📚", "☕", "💻"][index] }),
                  /* @__PURE__ */ jsx("span", { className: "text-gray-700 dark:text-gray-300", children: example })
                ] })
              },
              index
            )) })
          ...
          /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
            Button,
            {
              ...
              children: isGenerating ? /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx("div", { className: "mr-2 inline-block h-5 w-5 animate-spin rounded-full border-2 border-white border-t-transparent" }),
                "Generating..."
              ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx(Sparkles, { className: "mr-2 inline-block h-5 w-5" }),
                "Generate Optimized Prompt"
              ] })
            }
          ) }),
          isGenerating && /* @__PURE__ */ jsxs("div", { className: "py-8 text-center", children: [
            /* @__PURE__ */ jsx("div", { className: "mb-4 inline-block h-10 w-10 animate-spin rounded-full border-4 border-purple-200 border-t-purple-600" }),
            /* @__PURE__ */ jsx("p", { className: "text-purple-600 dark:text-purple-400", children: "Generating your optimized prompt..." })
          ] }),
          generatedPrompt && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-gray-50 p-6 dark:bg-gray-800", children: [
              /* @__PURE__ */ jsx("h2", { className: "mb-4 text-xl font-semibold text-gray-900 dark:text-white", children: "Your Optimized Prompt:" }),
              /* @__PURE__ */ jsx("div", { className: "min-h-[120px] rounded-lg border-l-4 border-purple-500 bg-white p-5 leading-relaxed whitespace-pre-wrap text-gray-700 dark:bg-gray-900 dark:text-gray-300", children: generatedPrompt }),
              /* @__PURE__ */ jsx("div", { className: "mt-4 flex items-center justify-between", children: /* @__PURE__ */ jsx(
                Button,
                {
                  onClick: handleCopy,
                  disabled: processing,
                  ...
                  children: copied ? /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx(Check, { className: "mr-2 inline-block h-4 w-4" }),
                    "Copied!"
                  ] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                    /* @__PURE__ */ jsx(Copy, { className: "mr-2 inline-block h-4 w-4" }),
                    "Copy to Clipboard"
                  ] })
                }
              ) })
            ...
            /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(
              Button,
              {
                ...
                children: processing ? /* @__PURE__ */ jsxs(Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsx(Save, { className: "mr-2 inline-block h-5 w-5" }),
