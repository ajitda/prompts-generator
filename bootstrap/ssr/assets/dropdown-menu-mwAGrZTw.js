import { r as reactExports, j as jsxRuntimeExports, t, c as reactDomExports, G, R as ReactDOM } from "../ssr.js";
import { e as composeRefs, u as useComposedRefs, c as cn } from "./createLucideIcon-BMlcDIBX.js";
...
function createCollection(name) {
  ...
  const CollectionProvider = (props) => {
    ...
    const itemMap = G.useRef(/* @__PURE__ */ new Map()).current;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionProviderImpl, { scope, itemMap, collectionRef: ref, children });
  };
  CollectionProvider.displayName = PROVIDER_NAME;
  const COLLECTION_SLOT_NAME = name + "CollectionSlot";
  const CollectionSlotImpl = /* @__PURE__ */ createSlot(COLLECTION_SLOT_NAME);
  const CollectionSlot = G.forwardRef(
    (props, forwardedRef) => {
      const { scope, children } = props;
  ...
  const CollectionItemSlot = G.forwardRef(
    (props, forwardedRef) => {
...
export {
  ...
  DropdownMenuItem as t,
  useControllableState as u,
  createContext2 as v,
  createSlottable as w,
