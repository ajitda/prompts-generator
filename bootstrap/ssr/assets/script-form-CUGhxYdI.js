...
const ScriptForm = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-background", children: /* @__PURE__ */ jsxs("main", { className: "container mx-auto px-6 max-w-3xl", children: [
    step === "input" && !isLoading && /* @__PURE__ */ jsxs("div", { className: "animate-fade-in flex flex-col items-center justify-center min-h-[60vh]", children: [
      /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mb-8", children: /* @__PURE__ */ jsx(Sparkles, { className: "w-8 h-8 text-primary" }) }),
      /* @__PURE__ */ jsx("h1", { className: "text-center mb-4 text-balance text-4xl font-bold", children: "What's your video about?" }),
      /* @__PURE__ */ jsxs("div", { className: "w-full max-w-lg space-y-4", children: [
        /* @__PURE__ */ jsx(
          Input,
          {
            value: keyword,
        ...
        /* @__PURE__ */ jsxs(Button, { variant: "default", onClick: handleGenerateIdeas, disabled: !keyword.trim() || currentCredits <= 0 || !fingerprint, size: "lg", className: "w-full gap-2", children: [
          "Generate video ideas ",
          /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4" })
        ] }),
        !isAuthenticated && /* @__PURE__ */ jsxs("p", { className: "text-center text-sm text-muted-foreground", children: [
          "You have ",
          currentCredits,
    ...
    step === "ideas" && !isLoading && /* @__PURE__ */ jsxs("div", { className: "animate-fade-in space-y-8", children: [
      /* @__PURE__ */ jsx("div", { className: "text-center space-y-3", children: /* @__PURE__ */ jsx("h2", { className: "text-3xl font-semibold", children: "Let's explore a few directions" }) }),
      /* @__PURE__ */ jsx("div", { className: "space-y-3", children: ideas.map((idea, index) => /* @__PURE__ */ jsx(IdeaCard, { idea, index }, index)) }),
      /* @__PURE__ */ jsx(Button, { variant: "ghost", onClick: handleStartOver, className: "w-full", children: "← Try a different topic" })
    ] }),
