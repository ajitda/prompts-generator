...
import { XIcon, PanelLeftIcon, Settings, LogOut, ChevronsUpDown, Video, Plus, BookOpen, ChevronRight } from "lucide-react";
import { c as cn, B as Button } from "./button-CIfObXh5.js";
...
function UserInfo({
  ...
  if (!user) {
    return /* @__PURE__ */ jsx("div", { className: "grid flex-1 text-left text-sm leading-tight", children: /* @__PURE__ */ jsx("span", { className: "truncate font-medium", children: "Guest" }) });
  }
...
function UserMenuContent({ user }) {
  ...
  console.log(user);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(DropdownMenuLabel, { className: "p-0 font-normal", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1 px-2 py-2", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-1 py-1 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsx("span", { children: "Credits remaining" }),
        /* @__PURE__ */ jsx(Badge, { variant: "outline", className: "font-semibold text-red-500", children: user.credits })
      ] }),
      /* @__PURE__ */ jsx(DropdownMenuSeparator, { className: "my-1" }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 px-1 py-1.5 text-left text-sm", children: /* @__PURE__ */ jsx(UserInfo, { user, showEmail: true }) })
    ] }) }),
...
function NavUser() {
  ...
  return /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxs(DropdownMenu, { onOpenChange: handleMenuOpen, children: [
    ...
    /* @__PURE__ */ jsx(
      DropdownMenuContent,
      {
        ...
        children: auth.user ? /* @__PURE__ */ jsx(UserMenuContent, { user: auth.user }) : /* @__PURE__ */ jsx("div", { className: "p-2", children: /* @__PURE__ */ jsx(
          SidebarMenuButton,
          {
            asChild: true,
            className: "w-full justify-start",
            children: /* @__PURE__ */ jsx("a", { href: "/login", children: "Sign in" })
          }
        ) })
      }
    )
...
function AppLogo() {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("img", { src: Logo, alt: "Brand Logo", width: "150" }) }) });
}
...
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxs(Sidebar, { collapsible: "icon", variant: "inset", children: [
    /* @__PURE__ */ jsx(SidebarHeader, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { size: "lg", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: "/", prefetch: true, children: /* @__PURE__ */ jsx(AppLogo, {}) }) }) }) }) }),
    /* @__PURE__ */ jsx(SidebarContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: dynamicGroups.map((group) => {
      const hasItems = group.items?.length > 0;
      return hasItems ? /* @__PURE__ */ jsx(
        Collapsible,
        {
          asChild: true,
          defaultOpen: false,
          ...
          children: /* @__PURE__ */ jsxs(SidebarMenuItem, { children: [
            /* @__PURE__ */ jsx(CollapsibleTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(
              SidebarMenuButton,
              {
                tooltip: group.title,
                children: [
                  /* @__PURE__ */ jsx(group.icon, { className: "h-4 w-4" }),
                  /* @__PURE__ */ jsx("span", { children: group.title })
                ]
              }
            ) }),
            /* @__PURE__ */ jsx(TooltipProvider, { delayDuration: 0, children: /* @__PURE__ */ jsx(Tooltip, { children: /* @__PURE__ */ jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx(SidebarMenuAction, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: group.baseHref, children: /* @__PURE__ */ jsx(
              Badge,
              {
                variant: "default",
                className: "mr-4",
            ...
            /* @__PURE__ */ jsx(CollapsibleContent, { children: /* @__PURE__ */ jsx(SidebarMenuSub, { children: group.items.map((item) => /* @__PURE__ */ jsx(
              SidebarMenuSubItem,
              {
                children: /* @__PURE__ */ jsx(
                  SidebarMenuSubButton,
                  {
                    ...
                    children: /* @__PURE__ */ jsx(
                      Link,
                      {
                        ...
                        children: /* @__PURE__ */ jsx("span", { children: item.keyword })
                      }
                    )
                  }
                )
        ...
        /* @__PURE__ */ jsx(
          SidebarMenuButton,
          {
            asChild: true,
            tooltip: group.title,
            children: /* @__PURE__ */ jsxs(Link, { href: group.href || "#", children: [
              /* @__PURE__ */ jsx(group.icon, { className: "h-4 w-4" }),
              /* @__PURE__ */ jsx("span", { children: group.title })
            ] })
          }
        ),
        group.action && /* @__PURE__ */ jsx(SidebarMenuAction, { asChild: true, children: /* @__PURE__ */ jsx(Link, { href: group.action.href, children: /* @__PURE__ */ jsx(
          Badge,
          {
            variant: "default",
            className: "mr-4",
...
function AppSidebarLayout({
  ...
  return /* @__PURE__ */ jsxs(AppShell, { variant: "sidebar", children: [
    ...
    /* @__PURE__ */ jsxs(AppContent, { variant: "sidebar", className: "overflow-x-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "p-4 pt-10", children })
    ] })
  ] });
}
